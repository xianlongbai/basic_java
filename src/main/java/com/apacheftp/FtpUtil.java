...
public class FtpUtil {
    ...
    // ftp服务器ip地址
    private static String FTP_ADDRESS = "172.30.105.117";
    // 端口号
    ...
    // 相对路径
    private static String FTP_BASEPATH = "test";
...
//    }
    ...
    public static void main(String[] args) throws FileNotFoundException {
        //测试上传
//        String originfilename = "C:\\Users\\HP\\Desktop\\oa相关问题\\test.txt";
//        InputStream inputStream = new FileInputStream(new File(originfilename));
//        uploadFile("test.txt",inputStream);

        //测试下载
        downloadFile("test.txt","C:\\Users\\HP\\Desktop\\apache_ftp");
    }
